...
//                          withRowAnimation:UITableViewRowAnimationTop];
    ...
    HPDetailViewController *detailViewController = [[HPDetailViewController alloc] initForNewItem:YES];
...
//    HPDetailViewController *detailViewController = [[HPDetailViewController alloc] init];
    HPDetailViewController *detailViewController = [[HPDetailViewController alloc] initForNewItem:NO];
   
    NSArray *items = [[HPItemStore sharedStore] allItems];
    MWItem *selectedItem = items[indexPath.row];
